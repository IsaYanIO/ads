...
const alg = 'HS256';
async function signJwt(payload, expiresIn = '2h') {
...
async function POST(req) {
    ...
    const payload = token ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyJwt"])(token) : null;
    if (!payload) {
    ...
    try {
        ...
        response.headers.set('Set-Cookie', (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])('token', token, {
            httpOnly: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03d3f1e5._.js.map